...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(snapshotData) => "${snapshotData} المستخدمين المستوردون حتى الآن";
  ...
  static String m10(errorMessage) => "رجائاً تحقق من اتصال الشبكة لديك.\n\n${errorMessage}";
  ...
  static String m14(thisTweetUserName, timeAgo) => "${thisTweetUserName} أعاد تغريد ${timeAgo}";
  ...
  static String m17(responseStatusCode) => "تعذر حفظ الوسائط. أعاد تويتر حالة ${responseStatusCode}";

  static String m18(e) => "غير قادر على إرسال البنج. ${e}";

  static String m19(statusCode) => "تعذر إرسال الأمر ping. كان رمز الحالة ${statusCode}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "disable_screenshots_hint":
            MessageLookupByLibrary.simpleMessage("منع التقاط لقطات الشاشة. قد لا يعمل هذا على جميع الأجهزة."),
        ...
        "mute_video_description":
            MessageLookupByLibrary.simpleMessage("لتحديد ما إذا كان يجب كتم مقاطع الفيديو افتراضيًا"),
        ...
        "only_public_subscriptions_can_be_imported":
            MessageLookupByLibrary.simpleMessage("لا يمكن استيراد الاشتراكات إلا من الملفات الشخصية العامة"),
        ...
        "page_not_found":
            MessageLookupByLibrary.simpleMessage("تويتر يقول إن الصفحة غير موجودة، ولكن هذا قد لا يكون صحيحا"),
        "permission_not_granted":
            MessageLookupByLibrary.simpleMessage("الإذن غير ممنوح. يرجى المحاولة مرة أخرى بعد منحه!"),
        ...
        "two_home_pages_required":
            MessageLookupByLibrary.simpleMessage("تحتاج إلى صفحتان على الأقل من صفحات الشاشة الرئيسية."),
        ...
        "you_must_have_at_least_2_home_screen_pages":
            MessageLookupByLibrary.simpleMessage("يجب أن يكون لديك على الأقل 2 صفحات الشاشة الرئيسية"),
