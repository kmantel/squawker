...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m10(errorMessage) => "Калі ласка, праверце вашае сеткавае падлучэнне.\n\n${errorMessage}";

  static String m11(releaseVersion) => "Націсніце, каб усталяваць ${releaseVersion}";

  static String m12(getMediaType) => "Націсніце, каб паказаць ${getMediaType}";

  static String m13(filePath) => "Файл не існуе. Калі ласка, упэўніцеся, што ён знаходзіцца па адрасе ${filePath}";

  static String m14(thisTweetUserName, timeAgo) => "${thisTweetUserName} ретвітнуў(ла) ${timeAgo}";
  ...
  static String m16(widgetPlaceName) => "Немагчыма загрузіць актуальнае для ${widgetPlaceName}";

  static String m17(responseStatusCode) => "Немагчыма захаваць мэдыяфайл. Twitter вярнуў статус ${responseStatusCode}";

  static String m18(e) => "Не ўдалося адправіць ping. ${e}";

  static String m19(statusCode) => "Не ўдалося адправіць ping. Код стану быў ${statusCode}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "activate_non_confirmation_bias_mode_label":
            MessageLookupByLibrary.simpleMessage("Уключыць рэжым зрушэння без пацверджання"),
        ...
        "could_not_find_any_tweets_by_this_user":
            MessageLookupByLibrary.simpleMessage("Не атрымалася знайсці ні аднаго твіту гэтага карыстальніка!"),
        "could_not_find_any_tweets_from_the_last_7_days":
            MessageLookupByLibrary.simpleMessage("Не атрымліваецца знайсці якія-небудзь твіты за апошнія 7 дзён!"),
        ...
        "enter_your_twitter_username":
            MessageLookupByLibrary.simpleMessage("Увядзіце Ваша імя карыстальніка ў Twitter"),
        ...
        "export_subscription_group_members":
            MessageLookupByLibrary.simpleMessage("Экспартаваць удзельнікаў груп падпісак?"),
        ...
        "let_the_developers_know_if_something_is_broken":
            MessageLookupByLibrary.simpleMessage("Паведаміце распрацоўшчыкам калі нешта пайшло не так"),
        ...
        "never_send": MessageLookupByLibrary.simpleMessage("Ніколі не адпраўляць"),
        ...
        "no_subscriptions_try_searching_or_importing_some":
            MessageLookupByLibrary.simpleMessage("Няма падпісак. Паспрабуйце пашукаць або імпартаваць нешта!"),
        ...
        "save_bandwidth_using_smaller_images":
            MessageLookupByLibrary.simpleMessage("Эканомце месца на экране, з выявамі меншага памеру"),
        ...
        "should_check_for_updates_description":
            MessageLookupByLibrary.simpleMessage("Правяраць наяўнасць абнаўленняў пры запуску"),
        ...
        "the_tweet_did_not_contain_any_text_this_is_unexpected":
            MessageLookupByLibrary.simpleMessage("Твіт не змяшчаў ніякага тэксту. Гэта нечакана"),
        ...
        "this_tweet_is_unavailable":
            MessageLookupByLibrary.simpleMessage("Гэты твіт недаступны. Магчыма ён быў выдалены."),
        "this_tweet_user_name_retweeted": m14,
        "this_user_does_not_follow_anyone": MessageLookupByLibrary.simpleMessage("Гэты карыстальнік нікога не чытае!"),
        "this_user_does_not_have_anyone_following_them":
            MessageLookupByLibrary.simpleMessage("Гэтага карыстальніка ніхто не чытае!"),
        ...
        "timed_out_trying_to_send_the_ping":
            MessageLookupByLibrary.simpleMessage("Перарвалася спроба адправіць ping 😢"),
        ...
        "unable_to_find_the_available_trend_locations":
            MessageLookupByLibrary.simpleMessage("Немагчыма знайсці даступныя краіны для актуальнага."),
        "unable_to_find_your_saved_tweets":
            MessageLookupByLibrary.simpleMessage("Немагчыма знайсці вашыя захаваныя твіты."),
        ...
        "unable_to_load_subscription_groups":
            MessageLookupByLibrary.simpleMessage("Не ўдаецца загрузіць групы падпісак"),
        ...
        "unable_to_load_the_list_of_follows":
            MessageLookupByLibrary.simpleMessage("Не атрымоўваецца загрузіць спіс падпісак"),
        "unable_to_load_the_next_page_of_follows":
            MessageLookupByLibrary.simpleMessage("Не атрымоўваецца загрузіць наступную старонку чытаемых"),
        "unable_to_load_the_next_page_of_replies":
            MessageLookupByLibrary.simpleMessage("Не ўдаецца загрузіць наступную старонку адказаў"),
        "unable_to_load_the_next_page_of_tweets":
            MessageLookupByLibrary.simpleMessage("Немагчыма загрузіць наступную старонку твітаў"),
        ...
        "unable_to_load_the_tweets_for_the_feed":
            MessageLookupByLibrary.simpleMessage("Не атрымліваецца загрузіць твіты для стужкі"),
        "unable_to_refresh_the_subscriptions": MessageLookupByLibrary.simpleMessage("Немагчыма абнавіць падпіскі"),
        "unable_to_run_the_database_migrations":
            MessageLookupByLibrary.simpleMessage("Не ўдалося зрабіць перамяшчэнне базы даных"),
        ...
        "unable_to_stream_the_trend_location_preference":
            MessageLookupByLibrary.simpleMessage("Немагчыма выканаць перадачу мясцовых пераваг"),
        ...
        "use_true_black_for_the_dark_mode_theme":
            MessageLookupByLibrary.simpleMessage("Выкарыстоўваць сапраўдны чорны (AMOLED) для цёмнай тэмы"),
        ...
        "which_tab_is_shown_when_the_app_opens":
            MessageLookupByLibrary.simpleMessage("Якая ўкладка адлюстроўваецца пры адкрыцці дадатку"),
        "would_you_like_to_enable_automatic_error_reporting":
            MessageLookupByLibrary.simpleMessage("Вы хочаце ўключыць аўтаматычнае інфармаванне аб памылках?"),
        "yes": MessageLookupByLibrary.simpleMessage("Так"),
        "yes_please": MessageLookupByLibrary.simpleMessage("Так, калі ласка"),
        "you_have_not_saved_any_tweets_yet":
            MessageLookupByLibrary.simpleMessage("Вы яшчэ не захавалі ніводнага твіту!"),
        "you_must_have_at_least_2_home_screen_pages":
            MessageLookupByLibrary.simpleMessage("Вы павінны ўсталяваць як мінімум дзве старонкі для галоўнага экрана"),
