...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(thisTweetUserName, timeAgo) => "${thisTweetUserName} 于 ${timeAgo} 前转推了";
  ...
  static String m17(responseStatusCode) => "无法保存媒体。Twitter 返回的状态是 ${responseStatusCode}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "an_error_was_reported_to_sentry_thank_you": MessageLookupByLibrary.simpleMessage("已向 Sentry 报告了一个错误。感谢！"),
        ...
        "timed_out_trying_to_send_the_ping": MessageLookupByLibrary.simpleMessage("Ping 传输超时 😢"),
        ...
        "whether_errors_should_be_reported_to_sentry": MessageLookupByLibrary.simpleMessage("是否向 Sentry 发送错误？👀"),
        ...
        "would_you_like_to_enable_automatic_error_reporting": MessageLookupByLibrary.simpleMessage("您希望自动发送错误报告吗？"),
        ...
        "your_device_is_running_a_version_of_android_older_than_kitKat_so_data_can_only_be_imported_from":
            MessageLookupByLibrary.simpleMessage("您的系统版本低于 Android 4.4，所以数据只能从这里导入："),
        "your_device_is_running_a_version_of_android_older_than_kitKat_so_the_export_can_only_be_saved_to":
            MessageLookupByLibrary.simpleMessage("您的系统版本低于 Android 4.4，因此导出的数据只能保存至以下位置："),
        "your_profile_must_be_public_otherwise_the_import_will_not_work":
            MessageLookupByLibrary.simpleMessage("你的个人资料必须是公开的，否则无法导入"),
        "your_report_will_be_sent_to_fritter_sentry_project":
            MessageLookupByLibrary.simpleMessage("您的报告将被发送至 Fritter 的 Sentry 项目，隐私详情可在下述位置找到：")
      };
}
