...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "Вы уверены, что хотите удалить группу подписок ${name}?";
  ...
  static String m5(snapshotData) => "Завершена работа с аккаунтами ${snapshotData}";

  static String m6(name) => "Группа: ${name}";

  static String m7(snapshotData) => "Импортировано ${snapshotData} аккаунтов на данный момент";
  ...
  static String m10(errorMessage) => "Пожалуйста, проверьте ваше сетевое подключение.\n\n${errorMessage}";

  static String m11(releaseVersion) => "Нажмите, чтобы установить ${releaseVersion}";

  static String m12(getMediaType) => "Нажмите, чтобы показать ${getMediaType}";

  static String m13(filePath) => "Файл не существует. Пожалуйста, убедитесь, что он находится по адресу ${filePath}";

  static String m14(thisTweetUserName, timeAgo) => "${thisTweetUserName} ретвитнул(а) ${timeAgo}";
  ...
  static String m16(widgetPlaceName) => "Невозможно загрузить актуальное для ${widgetPlaceName}";
  ...
  static String m19(statusCode) => "Не удалось отправить ping. Код состояния был ${statusCode}";

  static String m20(releaseVersion) => "Обновить до ${releaseVersion} через клиент F-Droid";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "activate_non_confirmation_bias_mode_label":
            MessageLookupByLibrary.simpleMessage("Включить режим смещения без подтверждения"),
        "add_to_group": MessageLookupByLibrary.simpleMessage("Добавить в группу"),
        "all": MessageLookupByLibrary.simpleMessage("Все"),
        "all_the_great_software_used_by_fritter":
            MessageLookupByLibrary.simpleMessage("Всё замечательное программное обеспечение, используемое "),
        "an_error_was_reported_to__thank_you":
            MessageLookupByLibrary.simpleMessage("Ошибка была передана в . Спасибо!"),
        "an_update_for_fritter_is_available": MessageLookupByLibrary.simpleMessage("Обновление  доступно! 🚀"),
        "are_you_sure": MessageLookupByLibrary.simpleMessage("Вы уверены?"),
        "are_you_sure_you_want_to_delete_the_subscription_group_name_of_group": m0,
        "back": MessageLookupByLibrary.simpleMessage("Назад"),
        "bad_guest_token": MessageLookupByLibrary.simpleMessage(
            "Twitter признал недействительным наш маркер доступа. Пожалуйста, попробуйте снова открыть !"),
        "blue_theme_based_on_the_twitter_color_scheme":
            MessageLookupByLibrary.simpleMessage("Синяя тема, основанная на цветовой схеме Twitter"),
        ...
        "confirm_close_fritter": MessageLookupByLibrary.simpleMessage("Вы действительно хотите закрыть ?"),
        ...
        "could_not_find_any_tweets_by_this_user":
            MessageLookupByLibrary.simpleMessage("Не удалось найти ни одного твита этого пользователя!"),
        "could_not_find_any_tweets_from_the_last_7_days":
            MessageLookupByLibrary.simpleMessage("Не удаётся найти какие-либо твиты за последние 7 дней!"),
        ...
        "download_media_no_url": MessageLookupByLibrary.simpleMessage(
            "Невозможно загрузить. Это медиа может быть доступно только в виде потока, который  пока не может загрузить."),
        ...
        "export_subscription_group_members":
            MessageLookupByLibrary.simpleMessage("Экспортировать участников групп подписок?"),
        ...
        "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Помогите сделать  ещё лучше"),
        "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Поддержите "),
        "here_is_the_data_that_will_be_sent_it_will_only_be_used_to_determine_which_devices_and_languages_to_support_in_fritter_in_the_future":
            MessageLookupByLibrary.simpleMessage(
                "Вот данные, которые будут отправлены. Они будут использованы только для определения того, какие устройства и языки будут поддерживаться в  в будущем."),
        "hide_sensitive_tweets": MessageLookupByLibrary.simpleMessage("Скрывать чувствительный контент"),
        "home": MessageLookupByLibrary.simpleMessage("Главная"),
        "if_you_have_any_feedback_on_this_feature_please_leave_it_on":
            MessageLookupByLibrary.simpleMessage("Если у вас есть отзывы об этой функции, пожалуйста, оставьте их на"),
        "import": MessageLookupByLibrary.simpleMessage("Импортировать"),
        "import_data_from_another_device":
            MessageLookupByLibrary.simpleMessage("Импортировать данные с другого устройства"),
        ...
        "it_looks_like_you_have_already_said_hello_from_this_version_of_fritter":
            MessageLookupByLibrary.simpleMessage("Похоже, что вы уже передали привет от этой версии !"),
        "it_looks_like_you_have_already_sent_a_ping_recently":
            MessageLookupByLibrary.simpleMessage("Похоже, что вы уже отправляли пинг недавно 🤔"),
        "joined": m8,
        ...
        "let_the_developers_know_if_something_is_broken":
            MessageLookupByLibrary.simpleMessage("Сообщите разработчикам если что-то пошло не так"),
        ...
        "never_send": MessageLookupByLibrary.simpleMessage("Никогда не отправлять"),
        ...
        "no_subscriptions_try_searching_or_importing_some":
            MessageLookupByLibrary.simpleMessage("Нет подписок. Попробуйте поискать или импортировать некоторые!"),
        ...
        "please_note_that_the_method_fritter_uses_to_import_subscriptions_is_heavily_rate_limited_by_twitter_so_this_may_fail_if_you_have_a_lot_of_followed_accounts":
            MessageLookupByLibrary.simpleMessage(
                "Учтите, что метод, используемый  для импорта подписок, сильно ограничен скоростью Twitter, поэтому при наличии большого количества подписок это может не сработать."),
        ...
        "save_bandwidth_using_smaller_images":
            MessageLookupByLibrary.simpleMessage("Экономьте место на экране, с изображениями меньшего размера"),
        "saved": MessageLookupByLibrary.simpleMessage("Избранное"),
        "say_hello": MessageLookupByLibrary.simpleMessage("Сказать привет"),
        "say_hello_emoji": MessageLookupByLibrary.simpleMessage("Сказать Привет 👋"),
        ...
        "send_a_non_identifying_ping_to_let_me_know_you_are_using_fritter_and_to_help_future_development":
            MessageLookupByLibrary.simpleMessage(
                "Отправьте анонимный пинг, чтобы я знал, что вы используете , и чтобы помочь будущей разработке"),
        "send_always": MessageLookupByLibrary.simpleMessage("Всегда отправлять"),
        ...
        "should_check_for_updates_description":
            MessageLookupByLibrary.simpleMessage("Проверять наличие обновлений при запуске"),
        ...
        "something_just_went_wrong_in_fritter_and_an_error_report_has_been_generated": MessageLookupByLibrary.simpleMessage(
            "Что-то пошло не так в , и был создан отчет об ошибке. Отчет можно отправить разработчикам , чтобы они могли устранить проблему."),
        "sorry_the_replied_tweet_could_not_be_found":
            MessageLookupByLibrary.simpleMessage("Извините, ответ не удалось найти!"),
        ...
        "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Спасибо за помощь ! 💖"),
        ...
        "the_github_issue": MessageLookupByLibrary.simpleMessage("предложение GitHub (#143)"),
        "the_tweet_did_not_contain_any_text_this_is_unexpected":
            MessageLookupByLibrary.simpleMessage("Твит не содержал никакого текста. Это неожиданно"),
        ...
        "this_tweet_is_unavailable":
            MessageLookupByLibrary.simpleMessage("Этот твит недоступен. Возможно он был удалён."),
        "this_tweet_user_name_retweeted": m14,
        "this_user_does_not_follow_anyone": MessageLookupByLibrary.simpleMessage("Этот пользователь никого не читает!"),
        "this_user_does_not_have_anyone_following_them":
            MessageLookupByLibrary.simpleMessage("Этого пользователя никто не читает!"),
        ...
        "timed_out_trying_to_send_the_ping":
            MessageLookupByLibrary.simpleMessage("Прервалась попытка отправить ping 😢"),
        ...
        "unable_to_find_the_available_trend_locations":
            MessageLookupByLibrary.simpleMessage("Не удается найти доступные страны для актуального."),
        "unable_to_find_your_saved_tweets":
            MessageLookupByLibrary.simpleMessage("Не удаётся найти ваши сохранённые твиты."),
        ...
        "unable_to_load_subscription_groups":
            MessageLookupByLibrary.simpleMessage("Не удаётся загрузить группы подписок"),
        "unable_to_load_the_group": MessageLookupByLibrary.simpleMessage("Не удаётся загрузить группу"),
        "unable_to_load_the_group_settings":
            MessageLookupByLibrary.simpleMessage("Не удаётся загрузить настройки группы"),
        "unable_to_load_the_list_of_follows":
            MessageLookupByLibrary.simpleMessage("Не удаётся загрузить список читаемых"),
        "unable_to_load_the_next_page_of_follows":
            MessageLookupByLibrary.simpleMessage("Не удаётся загрузить следующую страницу читаемых"),
        "unable_to_load_the_next_page_of_replies":
            MessageLookupByLibrary.simpleMessage("Не удаётся загрузить следующую страницу ответов"),
        "unable_to_load_the_next_page_of_tweets":
            MessageLookupByLibrary.simpleMessage("Не удаётся загрузить следующую страницу твитов"),
        "unable_to_load_the_profile": MessageLookupByLibrary.simpleMessage("Не удаётся загрузить профиль"),
        "unable_to_load_the_search_results":
            MessageLookupByLibrary.simpleMessage("Не удаётся загрузить результаты поиска."),
        ...
        "unable_to_load_the_tweets_for_the_feed":
            MessageLookupByLibrary.simpleMessage("Не удаётся загрузить твиты для ленты"),
        "unable_to_refresh_the_subscriptions": MessageLookupByLibrary.simpleMessage("Невозможно обновить подписки"),
        "unable_to_run_the_database_migrations":
            MessageLookupByLibrary.simpleMessage("Не удалось произвести перемещение базы данных"),
        ...
        "unable_to_stream_the_trend_location_preference":
            MessageLookupByLibrary.simpleMessage("Невозможно выполнить передачу местных предпочтений"),
        ...
        "use_true_black_for_the_dark_mode_theme":
            MessageLookupByLibrary.simpleMessage("Использовать настоящий чёрный (AMOLED) для тёмной темы"),
        ...
        "whether_errors_should_be_reported_to_": MessageLookupByLibrary.simpleMessage("Сообщать об ошибках в "),
        "whether_to_hide_tweets_marked_as_sensitive":
            MessageLookupByLibrary.simpleMessage("Следует ли скрывать твиты, помеченные как чувствительные"),
        "which_tab_is_shown_when_the_app_opens":
            MessageLookupByLibrary.simpleMessage("Какая вкладка отображается при открытии приложения"),
        "would_you_like_to_enable_automatic_error_reporting":
            MessageLookupByLibrary.simpleMessage("Вы хотите включить автоматическое информирование об ошибках?"),
        "yes": MessageLookupByLibrary.simpleMessage("Да"),
        "yes_please": MessageLookupByLibrary.simpleMessage("Да, пожалуйста"),
        "you_have_not_saved_any_tweets_yet":
            MessageLookupByLibrary.simpleMessage("Вы ещё не сохранили ни одного твита!"),
        "you_must_have_at_least_2_home_screen_pages":
            MessageLookupByLibrary.simpleMessage("Вы должны установить как минимум две страницы для главного экрана"),
        ...
        "your_report_will_be_sent_to_fritter__project": MessageLookupByLibrary.simpleMessage(
            "Ваш отчет будет отправлен в  , а информацию о конфиденциальности можно найти здесь:")
      };
}
