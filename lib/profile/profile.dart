...
import '../profile/_follows.dart';
import '../profile/_saved.dart';
import '../profile/_tweets.dart';
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          if (user.verified ?? false)
                                            const Icon(MaterialSymbols.verified, size: 24, color: Colors.blue)
                                        ],
                                      ),
                                      Container(
                                              ...
                                              if (user.friendsCount != null)
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      const Icon(MaterialSymbols.person, size: 12, color: Colors.white),
                                              ...
                                              if (user.location != null && user.location!.isNotEmpty)
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    crossAxisAlignment: CrossAxisAlignment.center,
                                                    children: [
                                                      const Icon(MaterialSymbols.location_on,
                                              ...
                                              if (user.createdAt != null)
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    crossAxisAlignment: CrossAxisAlignment.center,
                                                    children: [
                                                      const Icon(MaterialSymbols.calendar_today,
                                                          size: 12, color: Colors.white),
                                                      const SizedBox(width: 4),
                                                      Text(
                                                          L10n.of(context)
